...
const Posts = () => {
    ...
    return (
        ...
        <div className="flex flex-row gap-5 justify-center mr-0">
            ...
            <div className="flex flex-col items-end w-11/12 lg:w-7/12"> {/**Dropdown menu sort by */}
                <div className="flex flex-row justify-between p-2 text-sm font-medium w-full">
                    ...
                    <div className="relative inline-block text-left lg:hidden">
                            <div className="mr-3">
                                <button type="button" className="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-grey px-3 py-2 text-sm font-medium text-white ring-1  ring-light-grey ring-inset hover:bg-gray-50 focus:ring-lght-blue focus:text-lght-blue" id="menu-button" aria-expanded="true" aria-haspopup="true" 
                            ...
                            <div className={`absolute right-0 z-10 mt-2 mr-3  origin-top-right rounded-md bg-grey ring-1 shadow-lg ring-light-grey focus:outline-hidden ${
                                ...
                                <a href="#" className="block px-4 py-2 text-sm text-white m-1 rounded-md ring-1 ring-grey hover:text-lght-blue  hover:ring-lght-blue transition: duration-100 ease-linear" role="menuitem" tabIndex="-1" id="menu-item-0" onClick={() => handleTypeOptionClick("Rekomenduojami")}>Rekomenduojami</a>
                                <a href="#" className="block px-4 py-2 text-sm text-white m-1 rounded-md ring-1 ring-grey hover:text-lght-blue  hover:ring-lght-blue transition: duration-100 ease-linear" role="menuitem" tabIndex="-1" id="menu-item-1" onClick={() => handleTypeOptionClick("Populiarus")}>Populiarus</a>
                                <a href="#" className="block px-4 py-2 text-sm text-white m-1 rounded-md ring-1 ring-grey hover:text-lght-blue  hover:ring-lght-blue transition: duration-100 ease-linear" role="menuitem" tabIndex="-1" id="menu-item-2" onClick={() => handleTypeOptionClick("Nauji")}>Nauji</a>
                                </div>
                            </div>
                    </div>
                    <div className="relative inline-block text-left">
                            ...
                            <div className={`absolute right-0 z-10 mt-2 mr-3  origin-top-right rounded-md bg-grey ring-1 shadow-lg ring-light-grey focus:outline-hidden ${
                                    ...
                                    role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabIndex="-1">
                                <div className="" role="none">
                                <a href="#" className="block px-4 py-2 text-sm text-white m-1 rounded-md ring-1 ring-grey hover:text-lght-blue  hover:ring-lght-blue transition: duration-100 ease-linear" role="menuitem" tabIndex="-1" id="menu-item-0" onClick={() => handleSortOptionClick("Likes")}>Likes</a>
                                <a href="#" className="block px-4 py-2 text-sm text-white m-1 rounded-md ring-1 ring-grey hover:text-lght-blue  hover:ring-lght-blue transition: duration-100 ease-linear" role="menuitem" tabIndex="-1" id="menu-item-1" onClick={() => handleSortOptionClick("Komentarus")}>Komentarus</a>
                                <a href="#" className="block px-4 py-2 text-sm text-white m-1 rounded-md ring-1 ring-grey hover:text-lght-blue  hover:ring-lght-blue transition: duration-100 ease-linear" role="menuitem" tabIndex="-1" id="menu-item-2" onClick={() => handleSortOptionClick("Data")}>Data</a>
                                </div>
                            </div>
                    </div>
                </div>

  ...
  return (
    <>
      <div className="mt-5 mb-10 w-7/12 flex flex-row m-auto"> {/* Search bar */}
        <button className="bg-grey rounded-lg p-2 pl-4 pr-4 mr-2 hover:bg-dark transition-colors transition: 2s ease-linear">
        ...
        <button className="bg-grey border-lght-blue border-2 rounded-lg p-2 pl-4 pr-4 ml-2 hover:bg-dark transition-colors transition: 2s ease-linear">
      ...
      <div className="w-3/4 md:w-3/12 md:gap-20">
        <div className="w-full mb-10 md:mb-28"> {/* Prisijungusio vartotojo irasai */}
          <div className="flex flex-row mb-2 gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 text-green">
          ...
          <div className="  rounded-md p-2 flex items-center justify-center flex-col">
            <div className="flex w-full justify-between pt-2 p-2 pb-2 mb-3 pr-2 hover:bg-grey hover:rounded-md transition-colors transition: 2s ease-linear"> 
              <p className="text-white font-light text-base">Kokia jūsų patirtis šiame mo...</p>
            ...
            <div className="flex w-full justify-between pt-2 p-2 pb-2 mb-3 pr-2 hover:bg-grey hover:rounded-md transition-colors transition: 2s ease-linear"> 
              <p className="text-white font-light text-base">Ar VDU geriau negu KTU?</p>
              <div className="flex flex-row gap-1">
            ...
            <div className="flex w-full justify-center border-t-2 border-t-grey p-1 pt-2">
        ...
        <div className="w-full mt-5"> {/* Naujausiu irasu meniu */}
          <div className="flex flex-row mb-2 gap-2">
            ...
            <p className="text-white font-normal text-base">Naujausi įrašai</p>
          </div>
          
          <div className="rounded-md p-2 flex items-center justify-center flex-col">
            <div className="flex w-full justify-between pt-2 p-2 pb-2 mb-3 pr-2 items-center hover:bg-grey hover:rounded-md transition-colors transition: 2s ease-linear"> 
              <div>
                <p className="text-white font-light text-base">Kokia jūsų patirtis programų sistomese? Įdomios paskaitos?</p>
                <p className="text-light-grey font-medium text-sm">Įkelta: 2025-12-01</p>
              </div>
              <div className="flex flex-row gap-1">
                <p className="flex gap-1 text-white">2</p>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-white">
      ...
      <div className="w-3/4 md:w-8/12">
        ...
        <div className="w-full mb-16 bg-grey rounded-md">
          <div className="flex flex-row justify-between p-10">
            <div>
              ...
              <div className="flex flex-row gap-5 items-center">
                <p className="text-white font-extrabold text-lg">Suraskite universitetą kuris jus domina</p>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-10 text-lght-blue">
            ...
            <img src={Campus} alt="Campus" className="size-72 scale-x-[-1]  -translate-y-10"/>
          </div>
        </div>
        ...
        <div className="flex flex-row gap-2 mb-2">
          <button className="border-2 border-grey rounded-md p-3 text-sm text-white focus:bg-lght-blue focus:border-lght-blue hover:bg-lght-blue hover:border-lght-blue transition-colors transition: 2s ease-linear" 
        ...
        <div className="flex flex-col gap-2 mb-2 m-auto justify-center justify-items-center align-center"> {/* Universitetu forumu sarasas */}
          <div className="bg-grey rounded-md flex flex-row align-middle justify-between items-center hover:bg-dark cursor-pointer transition-colors transition: 2s ease-linear">
        ...
        <div className="grid grid-cols-2 gap-4 mt-5 md:grid-cols-3 md:gap-8"> {/* Kategoriju sarasas */}
          <div className="border-2 border-lght-blue bg-grey p-3 rounded-lg h-40 cursor-pointer hover:bg-dark transition-colors transition: 2s ease-linear">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-16 text-lght-blue m-auto">
          ...
          <div className="border-2 border-red bg-grey p-3 rounded-lg justify-items-center h-40 hover:bg-dark transition-colors transition: 2s ease-linear">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-16 text-red m-auto">
          ...
          <div className="border-2 border-green bg-grey p-3 rounded-lg justify-items-center h-40 hover:bg-dark transition-colors transition: 2s ease-linear">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-16 text-green m-auto">
          ...
          <div className="border-2 border-orange bg-grey p-3 rounded-lg justify-items-center h-40 hover:bg-dark transition-colors transition: 2s ease-linear">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-16 text-orange m-auto">
          ...
          <div className="border-2 border-purple bg-grey p-3 rounded-lg justify-items-center h-40 hover:bg-dark transition-colors transition: 2s ease-linear">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-16 text-purple">
          ...
          <div className="border-2 border-lght-blue bg-grey p-3 rounded-lg justify-items-center h-40 hover:bg-dark transition-colors transition: 2s ease-linear">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-16 text-lght-blue">
          ...
          <div className="border-2 border-red bg-grey p-3 rounded-lg justify-items-center h-40 hover:bg-dark transition-colors transition: 2s ease-linear">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-16 text-red">
